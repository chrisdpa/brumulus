...
def get_output(current_temp, target_temp, delta_temp_c, delta_time_ms):
    return rules[get_membership(current_temp, target_temp, delta_temp_c, delta_time_ms)]


def get_temperature_membership(current_temp, target_temp):
    for t in temp_memberships.keys():
        if (temp_memberships[t](current_temp, target_temp)):
            return t


def get_rate_of_change_membership(delta_temp_c, delta_time_ms):
...
def get_membership(current_temp, target_temp, delta_temp_c, delta_time_ms):
    return (get_temperature_membership(current_temp, target_temp),
            get_rate_of_change_membership(delta_temp_c, delta_time_ms))
